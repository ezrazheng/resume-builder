...
function setSidebarMode(mode) {
  sidebarMode = mode;
  localStorage.setItem('rb3_sidebar_mode', mode);
  ...
  if(btn) {
    ...
    if(mode === 'sections') {
      ...
      const sectionsModeMarkup = `
        <span data-action="full" title="Show editor" style="display:block;width:100%;text-align:center;padding:6px 0;cursor:pointer;line-height:1;pointer-events:auto">›</span>
        <span style="display:block;width:100%;height:1px;background:var(--border);pointer-events:none"></span>
        <span data-action="icons" title="Hide sidebar" style="display:block;width:100%;text-align:center;padding:6px 0;cursor:pointer;line-height:1;pointer-events:auto">‹</span>
      `;
