...
function renderPreview() {
  ...
  msrStyle.textContent = `.r-entry{margin-bottom:${Math.round(bodyFontSize * lineSpacing * 0.6)}px}.r-section{margin-bottom:${Math.round(bodyFontSize * lineSpacing * 0.8)}px}*{line-height:${lineSpacing}!important}`;
